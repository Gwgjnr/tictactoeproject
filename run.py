...
print('Players take turns marking the spaces in a 3×3 grid.\n')
print('The player who first places three of their marks in a')
print('diagonal, horizontal, or vertical row is the winner.\n')
